...
Avoidant attachment style will be negatively associated with positive emotions and anxious attachment style will be positivly associated with positive emotions.
...
#Regulator's instructions: "Imagine that your partner called you and started talking about their day. Below are short sections of what they said. Please rate which emotions and the intensity of the emotions that your partner might have felt during the day whey were expereincing the events they are describing."
...
plotp1<-ggplot(data=labdata,
              aes(x= Target_Attachment_Avoidance+Target_Attachment_Anxiety,
                  y=negative_exp))+
...
Prediction 2
```{r P2}
p2<-lm(negative_exp~Target_Attachment_Avoidance+Target_Attachment_Anxiety, data=labdata)
